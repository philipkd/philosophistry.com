...
<?php
	for($i=1; $i <= count($questions); $i++) {
		...
		print "><a href=\"?question=" . $i . "\">" . $questions[$i-1] . ".</a></li>\n";
	}
?>
</ol>
<span style="font-size: .9em;">&laquo; Move your mouse over countries to see individual percentages</span>
<p/>

<span style="font-size: .8em; color: #aaa">Surveyed countries: Austria, Belgium, Denmark, France, Germany, The Netherlands, Hungary, Italy, Poland, Spain, Switzerland, UK. Jews comprise 1% or less of each of these European countries. (1.4% of Americans are Jewish.)</span>
</div>
...
<?php
	if ($selected_question == 1) {
		$us_percent = "33";
		$us_color = 'bfbf60';
	} elseif ($selected_question == 2) {
		$us_percent = "19";
		$us_color = '97977b';
	}
	
	if ($us_percent) {
		echo '<br clear="all"><div style="background-color:#' . $us_color . '; color: black; width: 12em; padding: .2em; text-align: center; font-size: 12pt;">' . $us_percent . '% of Americans agree.</div>';
	}
...
<p class="boxright">Source: <a href="http://www.adl.org/main_Anti_Semitism_International/as_survey_2005.htm">2005 Anti-Defamation League Survey on Europe</a> <?php if ($us_percent) { echo '| <a href="http://www.adl.org/PresRele/ASUS_12/4680_12.htm">on the United States</a>'; } ?></p>
