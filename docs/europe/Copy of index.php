...
<head>
	<title>Map of Attitudes Toward Jews in 12 European Countries (2005)</title>
...
<h2>What percentage of European's agree that...</h2>
...
<?php
	for($i=1; $i <= count($questions); $i++) {
		print "\t<li><a href=\"question_" . $i . ".html\">" . $questions[$i-1] . "</a></li>\n";
	}
?>
</ol>
...
<p class="footnote">Created by <a href="mailto:philblog@dhingra.org">Philip Dhingra</a> and posted on <a href="http://www.philosophistry.com/">Philosophistry</a>.</p>
...
<p class="footnote">keywords: anti-semitism, map of Europe, flash</p>
