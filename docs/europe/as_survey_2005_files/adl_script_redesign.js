...
function setBgColor(src){
    ...
    var newWindow = window.open(param,'Answer2','width='+w+',height='+h+',scrollbars=no, resizable=no');
	if(newWindow.top != top) {newWindow.focus(); }
		...
		function openWindow_dimensions_flash(param, w, h) {
    var newWindow = window.open(param,'flash','width='+w+',height='+h+',scrollbars=no, resizable=no');
	if(newWindow.top != top) {newWindow.focus(); }
}		
